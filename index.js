...
async function run() {
  try {
    ...
    //pipe line er janno silo client jekhane all appoptions load karbo takhon ei api use karbo
     ...
     */
    //booking gulo  load korar 140-142 & jwt-133-138
    ...
    //db theke data load  karbo
    app.get("/users", async (req, res) => {
      const query = {};
      const users = await usersCollection.find(query).toArray();
      res.send(users);
    });
    //admin role email die chek korbe j se admin kina janno
